        ...
        <Box className="card-container">
            ...
            <Box className="codigo-porcentaje">
                ...
                <Box className="porcentaje">
                    ...
                    <CircularProgress value={60} size={esResolucionMobile ? "12.5rem" : "18.5rem"}>
                ...
                <>
                    ...
                    <Box className="avo-button">
                        <ButtonSubmitSecundario texto="Cargar Documentacion de AVO" event={() => navigate("/avo")} />
                    </Box>
                    ) : (
                    <Box className="avo-button">
                        <ButtonSubmitSecundarioDesktop text={"Cargar Documentacion de AVO"} event={() => navigate("/avo")} />
                    </Box>
                    )}
                </>
            </Box>

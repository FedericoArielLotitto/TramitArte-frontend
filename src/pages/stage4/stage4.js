        ...
        <Box className="card-container">
            ...
            <Box className="codigo-porcentaje">
                ...
                <Box className="porcentaje">
                    ...
                    <CircularProgress value={80} size={esResolucionMobile ? "12.5rem" : "18.5rem"}>
                ...
                <>
                    ...
                    <Box className="avo-button">
                        <ButtonSubmitSecundario texto="Traducir Documentos" event={() => navigate("/stage5")} />
                    </Box>
                    ) : (
                    <Box className="avo-button">
                        <ButtonSubmitSecundarioDesktop text={"Traducir Documentos"} event={() => navigate("/stage5")} />
                    </Box>
                    )}
                </>
            </Box>

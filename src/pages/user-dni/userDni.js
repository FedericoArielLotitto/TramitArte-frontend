...
import { Avatar, Box, Button, Divider, Modal, ModalCloseButton, ModalContent, ModalHeader, ModalOverlay, useDisclosure, useMediaQuery } from "@chakra-ui/react";
...
const UserDNIComponent = () => {
  ...
  const handleOnChange = (event) => {
    ...
    setTituloElegido(
      event.target.files[0] ? event.target.files[0].name : "No seleccionaste archivo"
    );

        ...
        <Box className="card-container">
            ...
            <Box className="codigo-porcentaje">
                ...
                <Box className="porcentaje">
                    ...
                    <CircularProgress value={40} size={esResolucionMobile ? "12.5rem" : "18.5rem"}>
                ...
                <>
                    ...
                    <Box className="avo-button">
                        <ButtonSubmitSecundario texto="Cargar Documentacion" event={() => navigate("/user-dni")} />
                    </Box>
                    ) : (
                    <Box className="avo-button">
                        <ButtonSubmitSecundarioDesktop text={"Cargar Documentacion"} event={() => navigate("/user-dni")} />
                    </Box>
                    )}
                </>
            </Box>

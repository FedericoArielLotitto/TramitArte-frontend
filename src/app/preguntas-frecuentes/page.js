    ...
    <ThemeProvider theme={theme}>
      <Box sx={{ height: "100%", backgroundColor: "terciario.contrastText" }}>
        <Accordion sx={{ padding: "2%", margin: 0 }}>
          ...
          <AccordionSummary
            sx={{
              backgroundColor: "terciario.main",
              color: "terciario.contrastText",
              margin: "2% 7%",
            ...
            expandIcon={
              <ExpandMoreIcon sx={{ color: "terciario.contrastText" }} />
            }
          ...
          <AccordionDetails sx={{ color: "terciario.main", margin: "0% 8%" }}>
            <Typography>
              Podés realizar la búsqueda de tu AVO (antepasado italiano que
              emigró) en:
              <ul>
                <li>
                  <a
                ...
                <li>
                  <a
                    href="https://antenati.cultura.gov.it/?lang=es"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Antenati
              ...
              Una vez terminada la búsqueda, cargá los datos en la sección Etapa
              1
            </Typography>
          </AccordionDetails>
        </Accordion>
        ...
        <Accordion sx={{ padding: "2%", margin: 0 }}>
          ...
          >
            <Typography>
              ¿Cómo solicitar la partida de nacimiento de mi AVO?
            </Typography>
          </AccordionSummary>
          <AccordionDetails sx={{ color: "terciario.main", margin: "0% 8%" }}>
            <Typography>
        ...
        <Accordion sx={{ padding: "2%", margin: 0 }}>
          ...
          >
            <Typography>
              ¿De dónde obtengo el mail y el teléfono de la Comuna en la que
              nació?
            </Typography>
          </AccordionSummary>
          <AccordionDetails sx={{ color: "terciario.main", margin: "0% 8%" }}>

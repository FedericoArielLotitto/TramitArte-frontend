                        ...
                        <div className="codigo-porcentaje">
                            ...
                            {esResolucionMobile ? (
                                        <div className="avo-button">
                                            <ButtonSubmitSecundario texto="Cargar documentación" event={() => navigate("/solicitante/dni")}></ButtonSubmitSecundario>
                                        </div>
                                        ) : (
                                        <div className="avo-button">
                                            <ButtomSubmitSecundarioDesktop text={"Cargar documentación"} event={() => navigate("/solicitante/dni")}/>
                                        </div>
                                    )}
                        </div>
                    </div>

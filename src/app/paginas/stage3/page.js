                        ...
                        <div className="codigo-porcentaje">
                            ...
                            {esResolucionMobile ? (
                                        <div className="avo-button">
                                            <ButtonSubmitSecundario texto="Cargar documentación de AVO" event={() => navigate("/solicitante/avo")}></ButtonSubmitSecundario>
                                        </div>
                                        ) : (
                                        <div className="avo-button">
                                            <ButtomSubmitSecundarioDesktop text={"Cargar documentación de AVO"} event={() => navigate("/solicitante/avo")}/>
                                        </div>
                                    )}
                        </div>
                    </div>

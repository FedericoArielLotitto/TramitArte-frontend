        ...
        <div className="columns-container">
          ...
          <div className="contenido">
            <div className="rollback-btn">
                <Button style={{width:"50px", height:"50px", backgroundColor:"white", borderRadius:"20px"}} onClick={() => navigate("/solicitante/stage4")}>
                      <DoneIcon style={{width:"35px", height:"35px", color:"black"}}/>
                </Button>
                <Button style={{backgroundColor:"white", height:"50px", borderRadius:"20px"}} onClick={() => navigate(-1)}>
                  <ArrowBackIcon/>
                </Button>
            </div>

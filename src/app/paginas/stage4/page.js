                        ...
                        <div className="codigo-porcentaje">
                            ...
                            {esResolucionMobile ? (
                                        <div className="avo-button">
                                            <ButtonSubmitSecundario texto="Traducir documentos" event={() => navigate("/solicitante/stage5")}></ButtonSubmitSecundario>
                                        </div>
                                        ) : (
                                        <div className="avo-button">
                                            <ButtomSubmitSecundarioDesktop text={"Traducir documentos"} event={() => navigate("/solicitante/stage5")}/>
                                        </div>
                                    )}
                        </div>
                    </div>
                    ...
                    <>
                        <div className="mensaje">
                            ...
                            <div className="modal-btn">
                                ...
                                <Button style={{width:"78px", height:"78px", backgroundColor:"#57C5B6"}} onClick={() => navigate("/home/solicitante")}>
